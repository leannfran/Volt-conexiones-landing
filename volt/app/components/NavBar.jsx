    ...
    <header className="text-gray-600 body-font bg-blue-volt">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        <nav className="flex lg:w-2/5 flex-wrap items-center text-base md:ml-auto text-white">
          ...
          <a href="#OurServices" className="mr-5 font-light hover:border-b-2 border-cyan-500 cursor-pointer">Servicios</a>
          <a href="#WorkDone" className="mr-5 font-light hover:border-b-2 border-cyan-500 cursor-pointer">Portafolio</a>
          <a href="#ContactUs" className="font-light hover:border-b-2 border-cyan-500 cursor-pointer">Contactanos</a>
        </nav>
