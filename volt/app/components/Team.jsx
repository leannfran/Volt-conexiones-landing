            ...
            <div class="wrapper">
              ...
              <div class="img-area">
                <div class="inner-area">
                  <img
                    src="#"
                    alt="Exequiel Abuin Fundador de Volt Conexiones"
                  />
                </div>
              </div>
              {/* Basic information */}
              ...
              <div className="text-center text-gray-400">
                Especializado en instalaciones industriales, Exequiel tiene más
                de 15 años de experiencia asegurando la calidad y eficiencia en
